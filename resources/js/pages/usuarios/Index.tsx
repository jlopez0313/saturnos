...
import { Edit3, Shield, Trash2 } from 'lucide-react';
...
export default function Index({ auth, roles, lista }: any) {
    ...
    const onPermisos = (id: number) => {
        router.visit(`/usuarios/${id}/permisos`);
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="overflow-x-auto px-4">
                <Table
                    user={auth.user}
                    data={data}
                    titles={['Nombre', 'Email', 'Rol', 'Sede', 'Ciudad', 'Departamento']}
                    actions={[
                        { icon: Shield, action: onPermisos, title: 'Permisos' },
